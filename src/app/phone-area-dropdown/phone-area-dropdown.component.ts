...
@Component({
  selector: 'app-phone-area-dropdown',
  standalone: true,
  imports: [CommonModule, MatIconModule],
  templateUrl: './phone-area-dropdown.component.html',
  styleUrl: './phone-area-dropdown.component.css'
})
export class PhoneAreaDropdownComponent {
