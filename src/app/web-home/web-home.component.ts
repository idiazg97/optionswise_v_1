...
import { AppHeaderWebComponent } from '../app-header-web/app-header-web.component';
import { StockServiceService } from '../services/stock-service.service';
import { PhoneNumber, SignUpInputComponent } from '../sign-up-input/sign-up-input.component';
import { CommonModule } from '@angular/common';
import { SignUpInputWebComponent } from "../sign-up-input-web/sign-up-input-web.component";
import { SmsVerificationWebComponent } from "../sms-verification-web/sms-verification-web.component";
...
@Component({
  ...
  standalone: true,
  imports: [LoadingScreenComponent, CommonModule, IntroAnimationComponent, HeaderComponent, SignUpInputComponent, SmsVerificationWebComponent, AppHeaderWebComponent, SignUpInputWebComponent],
