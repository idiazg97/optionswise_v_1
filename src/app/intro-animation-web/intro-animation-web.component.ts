...
@Component({
  selector: 'app-intro-animation-web',
  standalone: true,
  imports: [CommonModule, LottieComponent],
  templateUrl: './intro-animation-web.component.html',
  styleUrl: './intro-animation-web.component.css',
  animations: [
    trigger('scan', [
...
export class IntroAnimationWebComponent {
